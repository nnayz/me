      ...
      {isOpen && post && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 flex max-h-[85vh] max-w-[90vw] flex-col gap-4 md:flex-row"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Image */}
            <div className="relative max-h-[70vh] flex-shrink-0 md:max-h-[85vh]">
              <img
                src={getCurrentImageUrl()}
                alt={post.caption || 'Photography'}
                className="h-auto max-h-[70vh] w-auto max-w-full rounded-sm object-contain md:max-h-[85vh]"
              />
              {/* Carousel indicator */}
            ...
            {/* Sidebar info */}
            <div className="flex w-full flex-shrink-0 flex-col justify-between text-white md:w-64">
