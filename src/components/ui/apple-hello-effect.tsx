// ponytail: imports from framer-motion (already a dep) instead of adding `motion` — same API.
import { cn } from '@/lib/utils';
import { motion } from 'framer-motion';

// ponytail: inferred literals, not TargetAndTransition — framer-motion v10's
// `animate` prop type is narrower than that alias and rejects it.
const initialProps = {
  pathLength: 0,
  opacity: 0,
};
