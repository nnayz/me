    ...
    >
      <g clipPath="url(#path0)">
        ...
        <path
          ...
          clipRule="evenodd"
          d="M1 12C1 5.92487 5.92487 1 12 1H1190C1196.08 1 1201 5.92487 1201 12V52H1V12Z"
          fillRule="evenodd"
        />
        <circle className="fill-[#FF5F57]" cx="27" cy="25" r="6" />
        <circle className="fill-[#FEBC2E]" cx="47" cy="25" r="6" />
        <circle className="fill-[#28C840]" cx="67" cy="25" r="6" />
        <path
          className="fill-[#E5E5E5] dark:fill-[#404040]"
        ...
        {iframeSrc ? (
          ...
          <rect
            className="fill-[#f8f9fa] dark:fill-[#1a1a1a]"
            clipPath="url(#roundedBottom)"
            height={BASE_HEIGHT - 52}
            width={BASE_WIDTH - 2}
            x="1"
