  ...
  const Content = (
    ...
    >
      ...
      {(title || subtitle || meta) && (
        ...
        >
          {title && (
            <p className="line-clamp-1 font-[family-name:var(--font-display)] text-[10px] font-semibold tracking-tight text-white sm:text-xs">
              {title}
            </p>
          )}
          <div className="mt-0.5 flex items-center gap-1.5 text-[8px] text-white/70 sm:text-[9px]">
