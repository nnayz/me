...
function ContactLink({
  ...
  return (
    <span className="group block items-center">
      {website && (
        <p className="text-tertiary mb-0.5 text-[10px] font-medium uppercase tracking-wider">
          {website}
        </p>
      )}
      ...
      {email && (
        <p className="text-sm text-secondary transition-colors duration-150 hover:text-primary">
  ...
  return (
    <motion.div variants={fadeInUp} className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-3 md:grid-cols-3">
        ...
        <ContactLink
          href={[
            'https://www.instagram.com/nnasrrul/',
            'https://www.instagram.com/nasrultakesphotos/',
          ]}
